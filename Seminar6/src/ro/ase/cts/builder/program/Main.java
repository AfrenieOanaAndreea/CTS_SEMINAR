...
public class Main {
	...
	public static void main(String[] args) {
		...
		Rezervare rezervare2=new RezervareBuilder().setAreScaunErgonomic(true).
				setAreMuzicaAmbientala(true).setGenMuzical("rock").build();
		...
		Rezervare rezervare4=builder2.setAreScaunErgonomic(true).setAreMancareInclusa(true).build();
